...
public class BAutonomous extends OpMode {
    ...
    DcMotor rMotor1;
    DcMotor lMotor1;
    BeaconColorResult.BeaconColor beaconLeft;
    BeaconColorResult.BeaconColor beaconRight;
    ...
    enum state {testTurn, testForward, GetBeaconColor, stop, beacon,forward}
    ...
    public void beaconColor() {
        if (frameGrabber.isResultReady()) { //Wait for the result
            ...
            BeaconColorResult.BeaconColor leftColor = result.getLeftColor();
            BeaconColorResult.BeaconColor rightColor = result.getRightColor();
            beaconLeft=result.getLeftColor();
            beaconRight=result.getRightColor();
